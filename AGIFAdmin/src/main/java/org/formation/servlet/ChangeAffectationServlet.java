 ...
 * @author jean-laurent
 */
public class ChangeAffectationServlet extends HttpServlet {
	private static final long serialVersionUID = -6430703160946672148L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Changement d'affectation d'un stagiare</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Resultat du changement d'affectation du stagiaire : "
                    + "</h1>");
            if (!resultat.isEmpty()) {
                out.println("<ul>");
    ...
    public String getServletInfo() {
        return "Servlet de changement de l'affectation d'un stagaiire";
    }// </editor-fold>
    ...
    private List<String> getServletResult(HttpServletRequest request) {
        ...
        if (!service.changeAffectation(i)) {
            messages.add("Erreur dans la modication "
                    + " de l'inscription    " + i.toString());
            return messages;
        }
        messages.add("Changement de l'affectation de l'inscription " + i.toString()
