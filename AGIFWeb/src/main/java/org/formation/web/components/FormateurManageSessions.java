 ...
 * @author jean-laurent
 */
public class FormateurManageSessions extends Sessions {
    ...
    public FormateurManageSessions() {
    }

    public FormateurManageSessions(String intitule, int nbInscrits, Sessions s) {
