 ...
 * @author jean-laurent
 */
@ManagedBean(name="oublieMotdepasseBean")
@SessionScoped
public class OublieMotdepasseBean extends AbstractBackingBean {
	private static final long serialVersionUID = -6398630573010104866L;
