...
}(window.RichFaces,jQuery));;jQuery.atmosphere=function(){jQuery(window).bind("unload.atmosphere",function(){jQuery.atmosphere.unsubscribe()
});
...
})(window.RichFaces||(window.RichFaces={}));;(function(D,C){C.ui=C.ui||{};
